...
$sql = "SELECT * FROM admin WHERE id = '$email' AND pass = '$pswrd';";
$sql_result = mysqli_query ($conn, $sql) or die ('request "Could not execute SQL query" '.$sql);
		$user = mysqli_fetch_assoc($sql_result);
		if(!empty($user)){
			$_SESSION['user_info'] = $user['id'];
			$message='LOGGING IN SUCCESSFUL';
			echo "<script type='text/javascript'>window.location = 'addtrain.php';</script>";
		}
		else{
...
<body>
	...
	<div id="loginarea">
	<form id="login" action="admin.php" onsubmit="return validate()" method="post" name="login">
	<div id="logintext">Admin Login!</div><br/><br/>
	<table>
