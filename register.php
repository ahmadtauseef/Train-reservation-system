...
$ac = $_POST['ac'];
$aad = $_POST['aad'];
$sql = "INSERT INTO passengers (p_fname, p_lname, p_age, p_contact, p_gender, email, password, Aadhar, Account_number, Balance) VALUES ('$fname', '$lname', '$age', '$mob', '$gender', '$email', '$pw','$aad', '$ac',500)";
...
<TR class="left">
<TD><FONT size="3" color="WHITE">Age:</FONT></TD>
<TD><INPUT type="TEXT" name="age" align="center" size="30" maxlength="3" placeholder="Enter age" id="age"></TD>
</TR><tr></tr><tr></tr>
<TR class="left">
<TD><FONT size="3" color="WHITE">Mobile Number:</FONT></TD>
<TD><INPUT type="TEXT" name="mob" size="30" maxlength="10" placeholder="Enter your mobile number" id="mob"></TD>
</TR><tr></tr><tr></tr>
<TD><FONT size="3" color="WHITE">AADHAR:</FONT></TD>
<TD><INPUT type="TEXT" name="aad" size="30" maxlength="15" placeholder="Please enter our AADHAR " id="aad"></TD>
</TR><tr></tr><tr></tr>
<TD><FONT size="3" color="WHITE">Bank Account No.:</FONT></TD>
<TD><INPUT type="TEXT" name="ac" size="30" maxlength="16" placeholder="Enter your Account Number" id="ac"></TD>
</TR><tr></tr><tr></tr>
<TR class="left">
<TR class="left">
...
<br> &nbsp;&nbsp;
<input type="radio" name="gender" value="Transgender" align="center" id="gender">Transgender
</TD>
</TR><tr></tr><tr></tr>
<TR class="left">
...
<TR class="left">
<TD><FONT size="3" color="WHITE">Confirm Password:</FONT></TD>
